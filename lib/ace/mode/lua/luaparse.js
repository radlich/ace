...
(function (root, name, factory) {
  ...
  function lex() {
    ...
    switch (charCode) {
      ...
      // * ^ % , { } | ] ( ) ; # - + &
      case 42: case 94: case 37: case 44: case 123: case 125: case 124:
  ...
  function binaryPrecedence(operator) {
    ...
    if (1 === length) {
      ...
      if ((60 === charCode && '<<' === operator) ||
          (62 === charCode && '>>' === operator)) {
        return 7;
      } else if ((60 === charCode && '<=' === operator) ||
                 (62 === charCode && '>=' === operator)) {
        return 3;
      }
    } else if (3 === length) {
      if (110 === charCode && 'not' === operator) {
        return 11;
